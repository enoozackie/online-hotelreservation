<?php
// =============================================================================
// admin/reservations/pending_reservations.php - Admin Pending Reservations Page
// =============================================================================
...
$pendingCount = count($reservations);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Pending Reservations - Monbela Hotel</title>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="pending_reservations.php" class="active">
        ...
        <main class="main-content">
            <div class="content-header">
                <div>
                    <h1><i class="bi bi-clock-history"></i> Pending Reservations</h1>
                    <p>Review and manage reservations awaiting confirmation</p>
                </div>
                <a href="manage_reservations.php" class="btn btn-primary">
            ...
            <div class="reservations-container">
                <div class="reservations-header">
                    <h2><i class="bi bi-hourglass-split"></i> Awaiting Approval</h2>
                ...
                <div class="table-responsive">
                    <?php if (empty($reservations)): ?>
                        <div class="text-center p-4">
                            ...
                            <p>All reservations have been processed. Great job!</p>
                            <a href="manage_reservations.php" class="btn btn-primary mt-2">
                                <i class="bi bi-calendar-check"></i> View All Reservations
                            </a>
                        </div>
                    <?php else: ?>
                                ...
                                <?php foreach ($reservations as $reservation): ?>
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <a href="confirm_reservation.php?id=<?= $reservation['RESERVEID'] ?>" class="btn btn-sm btn-success" title="Confirm"
                                               onclick="return confirm('Confirm reservation #<?= $reservation['RESERVEID'] ?>?');">
                                                <i class="bi bi-check"></i>
                                            </a>
                                            <a href="cancel_reservation.php?id=<?= $reservation['RESERVEID'] ?>" class="btn btn-sm btn-danger" title="Reject"
                                               onclick="return confirm('Reject reservation #<?= $reservation['RESERVEID'] ?>?');">
                                                <i class="bi bi-x"></i>
                                            </a>
                                        </td>
                                    </tr>
